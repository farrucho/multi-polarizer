  ...
  void reseting() {
    ...
    // FITTING BRUTEFORCE ALGORITHM
      ...
      if(bruteForce == true){
        ...
        double initial_angle = 30.6;
        double max_angle = 57.6;
